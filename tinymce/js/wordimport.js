var WordImportDialog = {
	...
	import : function(file, title) {
		...
		if (f.src.value === '') {
			if (ed.selection.getNode().nodeName == 'WORDIMPORT') {
...
WordImportDialog.preInit();
tinyMCEPopup.onInit.add(WordImportDialog.init, WordImportDialog);
